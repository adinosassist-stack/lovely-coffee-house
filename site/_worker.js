...
export default {
  async fetch(request, env) {
    ...
    // then 20m) to avoid repeated paid-provider probes while preserving faster automatic
    // recovery on the paid Workers runtime. The sealed R20 validators/rate limits still run.
